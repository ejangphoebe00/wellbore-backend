...
class CraneUser(db.Model):
    ...
    UserPremsUser_id = db.Column(db.Integer,nullable=True)
    ...
    LoginErrorCount = db.Column(db.Integer,nullable=False)
    LoginStatus_id = db.Column(db.Integer,nullable=False)
