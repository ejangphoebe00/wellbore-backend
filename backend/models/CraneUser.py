...
class CraneUser(db.Model):
    ...
    DateCreated = db.Column(db.DateTime,server_default=datetime.utcnow)
    ModifiedOn = db.Column(db.DateTime,server_default=datetime.utcnow,onupdate=db.func.current_timestamp())
    ...
    DefaultChangeDate = db.Column(db.DateTime,server_default=datetime.utcnow, onupdate=db.func.current_timestamp())
