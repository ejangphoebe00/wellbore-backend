...
class CoreCatalog(db.Model):
    ...
    WellboreCore_id = db.Column(db.Integer, db.ForeignKey('crane.t_WellboreCore.WellboreCore_id'),nullable=False)
    CoreType = db.Column(db.Integer, db.ForeignKey('crane.rt_CoreType.CoreType_id'),nullable=False)
    ...
    CoreCatalogSecurityFlag_id = db.Column(db.Integer, db.ForeignKey('crane.rt_CatalogSecurityFlag.CatalogSecurityFlag_id'),nullable=True)
    WasAnalysed_id = db.Column(db.Integer)
    TopStratLitho_id = db.Column(db.Integer, db.ForeignKey('crane.t_StratLithoUnit.StratLitho_id'),nullable=True)
    BottomStratLitho_id = db.Column(db.Integer, db.ForeignKey('crane.t_StratLithoUnit.StratLitho_id'),nullable=True)
    ...
    CatalogReportFormat_id = db.Column(db.Integer, db.ForeignKey('crane.rt_FileFormat.FileFormat_id'),nullable=True)
    CatalogReportFileSize = db.Column(db.DECIMAL)
    CatalogReportSecurityGrade_id = db.Column(db.Integer, db.ForeignKey('crane.rt_FileSecurityGrade.FileSecurityGrade_id'),nullable=True)
