...
class Wellbore(db.Model):
    ...
    DST_Contractor_id = db.Column(db.Integer, db.ForeignKey('Company.Company_id'),nullable=True)
    HasPetrophysicalLogs_id = db.Column(db.Integer)
    PetrophysicalContractor_id = db.Column(db.Integer, db.ForeignKey('Company.Company_id'),nullable=True)
