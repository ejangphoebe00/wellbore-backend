...
class Wellbore(db.Model):
    ...
    LicenseOperatorCompany_id = db.Column(db.Integer)
    DrillingContractorCompany_id = db.Column(db.Integer)
    ...
    DST_Contractor_id = db.Column(db.Integer)
    HasPetrophysicalLogs_id = db.Column(db.Integer)
    PetrophysicalContractor_id = db.Column(db.Integer)
