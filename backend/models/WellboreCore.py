...
class WellboreCore(db.Model):
    ...
    Wellbore_id = db.Column(db.Integer,nullable=True)
    CoreNumber = db.Column(db.NVARCHAR(255))
    CoringDate = db.Column(db.Date)
    WBCoringContractor_id = db.Column(db.Integer)
    ...
    CoreTopStratLitho_id = db.Column(db.Integer)
    CoreBottomStratLitho_id = db.Column(db.Integer)
    ...
    ReportFormat_id = db.Column(db.Integer)
    ReportFileSize = db.Column(db.DECIMAL)
    CoreReportSecurityGrade_id = db.Column(db.Integer)
