...
def upgrade():
    ...
    sa.ForeignKeyConstraint(['UserWebSecurityLevel_id'], ['geosims_rt_CraneWebSecurityLevel.WebSecurityLevel_id'], ),
    ...
    sa.ForeignKeyConstraint(['CreatedBy'], ['geosims_t_CraneUser.CraneUser_id'], ),
    ...
    sa.Column('Comments', sa.NVARCHAR(length=500), nullable=True),
    sa.ForeignKeyConstraint(['HistLogUser_id'], ['geosims_t_CraneUser.CraneUser_id'], ),
    ...
    sa.Column('ModifiedOn', sa.DateTime(), nullable=True),
    sa.Column('ModifiedBy', sa.Integer(), nullable=True),
    sa.ForeignKeyConstraint(['CoreContractor_id'], ['geosims_t_Company.Company_id'], ),
    sa.ForeignKeyConstraint(['CreatedBy_id'], ['geosims_t_CraneUser.CraneUser_id'], ),
    sa.ForeignKeyConstraint(['DST_Contractor_id'], ['geosims_t_Company.Company_id'], ),
    sa.ForeignKeyConstraint(['DrillingContractorCompany_id'], ['geosims_t_Company.Company_id'], ),
    sa.ForeignKeyConstraint(['LicenseOperatorCompany_id'], ['geosims_t_Company.Company_id'], ),
    sa.ForeignKeyConstraint(['ModifiedBy'], ['geosims_t_CraneUser.CraneUser_id'], ),
    ...
    sa.ForeignKeyConstraint(['CreatedBy_id'], ['geosims_t_CraneUser.CraneUser_id'], ),
    sa.ForeignKeyConstraint(['ModifiedBy'], ['geosims_t_CraneUser.CraneUser_id'], ),
    sa.ForeignKeyConstraint(['Sampling_company'], ['geosims_t_Company.Company_id'], ),
    sa.ForeignKeyConstraint(['Wellbore_id'], ['geosims_t_Wellbore.Wellbore_id'], ),
    sa.PrimaryKeyConstraint('Sample_id')
    )
