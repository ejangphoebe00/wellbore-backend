...
Revision ID: 11e58f868526
Revises: 655b063128a9
Create Date: 2021-07-09 13:10:24.442597
...
revision = '11e58f868526'
down_revision = '655b063128a9'
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    sa.ForeignKeyConstraint(['CreatedBy'], ['crane.t_CraneUser.CraneUser_id'], ),
    sa.ForeignKeyConstraint(['ModifiedBy'], ['crane.t_CraneUser.CraneUser_id'], ),
    ...
    sa.Column('ModifiedOn', sa.DateTime(), nullable=True),
    sa.Column('ModifiedBy', sa.Integer(), nullable=True),
    sa.ForeignKeyConstraint(['CoreContractor_id'], ['crane.t_Company.Company_id'], ),
    sa.ForeignKeyConstraint(['CreatedBy_id'], ['crane.t_CraneUser.CraneUser_id'], ),
    sa.ForeignKeyConstraint(['DST_Contractor_id'], ['crane.t_Company.Company_id'], ),
    sa.ForeignKeyConstraint(['DrillingContractorCompany_id'], ['crane.t_Company.Company_id'], ),
    sa.ForeignKeyConstraint(['LicenseOperatorCompany_id'], ['crane.t_Company.Company_id'], ),
    sa.ForeignKeyConstraint(['ModifiedBy'], ['crane.t_CraneUser.CraneUser_id'], ),
    sa.ForeignKeyConstraint(['PetrophysicalContractor_id'], ['crane.t_Company.Company_id'], ),
    sa.ForeignKeyConstraint(['Prospect_id'], ['crane.t_Company.Company_id'], ),
    ...
    sa.Column('ModifiedOn', sa.DateTime(), nullable=True),
    sa.Column('ModifiedBy', sa.Integer(), nullable=True),
    sa.ForeignKeyConstraint(['CoreBottomStratLitho_id'], ['crane.t_StratLithoUnit.StratLitho_id'], ),
    sa.ForeignKeyConstraint(['CoreReportSecurityGrade_id'], ['crane.rt_FileSecurityGrade.FileSecurityGrade_id'], ),
    sa.ForeignKeyConstraint(['CoreTopStratLitho_id'], ['crane.t_StratLithoUnit.StratLitho_id'], ),
    sa.ForeignKeyConstraint(['CreatedBy_id'], ['crane.t_CraneUser.CraneUser_id'], ),
    sa.ForeignKeyConstraint(['ModifiedBy'], ['crane.t_CraneUser.CraneUser_id'], ),
    sa.ForeignKeyConstraint(['ReportFormat_id'], ['crane.rt_FileFormat.FileFormat_id'], ),
    sa.ForeignKeyConstraint(['WBCoringContractor_id'], ['crane.t_Company.Company_id'], ),
